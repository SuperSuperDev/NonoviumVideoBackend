...
class Media(models.Model):
    """The most important model for NonoviumVideo"""
    ...
    featured = models.BooleanField(
        default=False,
        db_index=True,
        help_text="Whether media is globally featured by a NonoviumVideo editor",
    )
    ...
    reported_times = models.IntegerField(
        default=0, help_text="how many time a media is reported"
    )
