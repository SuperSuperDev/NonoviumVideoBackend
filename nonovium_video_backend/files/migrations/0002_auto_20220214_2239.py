...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='media',
            name='category',
            field=models.ManyToManyField(blank=True, help_text='Media can be part of one or more categories', to='files.Category'),
        ),
        migrations.AddField(
            model_name='media',
            name='channel',
            field=models.ForeignKey(blank=True, help_text='Media can exist in one or no Channels', null=True, on_delete=django.db.models.deletion.CASCADE, to='users.channel'),
        ),
        migrations.AddField(
            model_name='media',
            name='license',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='files.license'),
        ),
        migrations.AddField(
            model_name='media',
            name='rating_category',
