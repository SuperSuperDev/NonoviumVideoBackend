...
import nonovium_video_backend.files.models
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', imagekit.models.fields.ProcessedImageField(blank=True, upload_to=nonovium_video_backend.files.models.category_thumb_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_file', models.FileField(blank=True, max_length=500, upload_to=nonovium_video_backend.files.models.encoding_media_file_path, verbose_name='encoding file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_date', models.DateTimeField(blank=True, db_index=True, null=True, verbose_name='Date produced')),
                ...
                ('featured', models.BooleanField(db_index=True, default=False, help_text='Whether media is globally featured by a NonoviumVideo editor')),
                ...
                ('media_file', models.FileField(help_text='media file', max_length=500, upload_to=nonovium_video_backend.files.models.original_media_file_path, verbose_name='media file')),
                ...
                ('poster', imagekit.models.fields.ProcessedImageField(blank=True, help_text='media extracted big thumbnail, shown on media page', max_length=500, upload_to=nonovium_video_backend.files.models.original_thumbnail_file_path)),
                ...
                ('sprites', models.FileField(blank=True, help_text='sprites file, only for videos, displayed on the video player', max_length=500, upload_to=nonovium_video_backend.files.models.original_thumbnail_file_path)),
                ...
                ('thumbnail', imagekit.models.fields.ProcessedImageField(blank=True, help_text='media extracted small thumbnail, shown on listings', max_length=500, upload_to=nonovium_video_backend.files.models.original_thumbnail_file_path)),
                ...
                ('uploaded_thumbnail', imagekit.models.fields.ProcessedImageField(blank=True, help_text='thumbnail from uploaded_poster field', max_length=500, upload_to=nonovium_video_backend.files.models.original_thumbnail_file_path)),
                ('uploaded_poster', imagekit.models.fields.ProcessedImageField(blank=True, help_text='This image will characterize the media', max_length=500, upload_to=nonovium_video_backend.files.models.original_thumbnail_file_path, verbose_name='Upload image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_date', models.DateTimeField(auto_now_add=True)),
                ('score', models.IntegerField(validators=[nonovium_video_backend.files.models.validate_rating])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subtitle_file', models.FileField(help_text='File has to be WebVTT format', max_length=500, upload_to=nonovium_video_backend.files.models.subtitles_file_path, verbose_name='Subtitle/CC file')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
