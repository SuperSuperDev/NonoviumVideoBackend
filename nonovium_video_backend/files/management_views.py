...
from nonovium_video_backend.users.serializers import UserSerializer

from .methods import is_nonoviumvideo_manager
...
class MediaList(APIView):
    """Media listings
    Used on management pages of NonoviumVideo
    Should be available only to NonoviumVideo editors,
    managers and admins
    """
    ...
    @swagger_auto_schema(
        ...
        operation_description="Manage media for NonoviumVideo managers and reviewers",
    )
    ...
    @swagger_auto_schema(
        ...
        operation_description="Delete media for NonoviumVideo managers and reviewers",
    )
...
class CommentList(APIView):
    ...
    @swagger_auto_schema(
        ...
        operation_description="Manage comments for NonoviumVideo managers and reviewers",
    )
    def get(self, request, format=None):
        params = self.request.query_params
        ordering = params.get("ordering", "").strip()
    ...
    @swagger_auto_schema(
        ...
        operation_description="Delete comments for NonoviumVideo managers and reviewers",
    )
    def delete(self, request, format=None):
...
class UserList(APIView):
    ...
    @swagger_auto_schema(
        ...
        operation_description="Manage users for NonoviumVideo managers and reviewers",
    )
    def get(self, request, format=None):
        params = self.request.query_params
        ordering = params.get("ordering", "").strip()
    ...
    @swagger_auto_schema(
        ...
        operation_description="Delete users for NonoviumVideo managers",
    )
    def delete(self, request, format=None):
        if not is_nonoviumvideo_manager(request.user):
            return Response(
